...
-- TODO split equality goals
-- example (e b c a v0 v1 : Int) (h1 : v0 = 5*a) (h2 : v1 = 3*b) (h3 : v0 + v1 + c = 10) :
...
-- TODO what about allowing `and` in the goal?
example (ε : Int) (_ : ε > 0) : ε - 3 ≤ ε / 3 + ε / 3 + ε / 3 := by omega
...
-- TODO split equalities in the goal
...
example (a : Int) (ha : 0 ≤ a) : 0 * 0 ≤ 2 * a := by
  omega
